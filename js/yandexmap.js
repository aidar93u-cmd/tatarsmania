...
var tatarsmaniaMapStyle = [{"featureType":"all","elementType":"all","stylers":[{"visibility":"on"}]},{"featureType":"all","elementType":"geometry","stylers":[{"saturation":"1"},{"lightness":"21"},{"weight":"1"}]},{"featureType":"all","elementType":"geometry.fill","stylers":[{"lightness":"-10"}]},{"featureType":"all","elementType":"geometry.stroke","stylers":[{"lightness":"-100"},{"weight":"0.15"}]},{"featureType":"all","elementType":"labels.text.fill","stylers":[{"lightness":"-100"},{"visibility":"on"},{"weight":"0.01"}]},{"featureType":"all","elementType":"labels.text.stroke","stylers":[{"weight":"0.01"}]},{"featureType":"administrative","elementType":"labels.text.fill","stylers":[{"color":"#444444"}]},{"featureType":"administrative.locality","elementType":"labels","stylers":[{"lightness":"50"}]},{"featureType":"landscape","elementType":"all","stylers":[{"color":"#f2f2f2"}]},{"featureType":"poi","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"road","elementType":"all","stylers":[{"saturation":-100},{"lightness":45}]},{"featureType":"road.highway","elementType":"all","stylers":[{"visibility":"simplified"}]},{"featureType":"road.arterial","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{"featureType":"transit","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"water","elementType":"all","stylers":[{"color":"#ffffff"},{"visibility":"on"}]}]
...
function initYandexMap() {
	...
	// Apply custom styles after map is ready
	map.events.once('ready', function () {
		try {
			map.options.set('customStyles', { base: tatarsmaniaMapStyle, decor: {} })
		} catch (e) {
			console.warn('customStyles via options.set failed:', e)
		}
	})
	...
	document
		...
		.forEach(function (card) {
			...
			var balloonHtml =
				...
				'<div class="map-balloon__row map-balloon__row--address"><span>' + address + '</span><span>' + hours + '</span></div>' +
				'<div class="map-balloon__row"><a href="tel:' + phoneRaw + '" class="map-balloon__phone">' + phone + '</a></div>' +
				'<div class="map-balloon__row map-balloon__row--status"><span>' + statusText + '</span></div>' +
				'</div>' +
				'</div>'
