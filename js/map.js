...
;(function () {
  ...
  function createPlacemark(lat, lng, name, balloonHtml) {
  ...
  function initSimpleMap() {
    ...
    document
      ...
      .forEach(function (card, index) {
        ...
        var placemark = createPlacemark(lat, lng, name, balloonHtml)
        map.geoObjects.add(placemark)

        if (checkoutMode) {
          window.__checkoutMarkers.push(placemark)
